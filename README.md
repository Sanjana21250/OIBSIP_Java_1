...
## Overview
The Online Reservation System is a Java-based application developed as part of an internship task. The project simulates a basic railway reservation system that allows users to book and cancel tickets efficiently while maintaining data in a centralized structure. This project demonstrates core programming concepts, system design, and modular development using Java.
## Objective
* To design a system that simplifies ticket reservation and cancellation
...
* Auto-fills train name based on train number
* Generates a unique PNR
Stores booking details
3. Cancellation Module
* Accepts PNR number
* Displays booking details
* Confirms and processes cancellation
## Tech Stack
* Language: Java
* Concepts Used:
